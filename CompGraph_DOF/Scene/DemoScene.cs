    ...
    public DemoScene()
    {
        ...
        var objects = new List<SceneObject>
        {
            new(
                ...
                "Near Cube",
                _cubeMesh,
                Matrix4x4.CreateScale(1f) * Matrix4x4.CreateRotationY(0.55f) * Matrix4x4.CreateTranslation(-2.2f, 0f, 4.0f),
            ...
            new(
                ...
                "Center Sphere",
                _sphereMesh,
                Matrix4x4.CreateScale(1f) * Matrix4x4.CreateTranslation(0.0f, 0f, 0.0f),
